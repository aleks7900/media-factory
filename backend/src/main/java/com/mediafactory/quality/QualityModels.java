...
public final class QualityModels {
  ...
  public enum Source {TECHNICAL, VISION_MODEL, HUMAN, SIMILARITY}

  public enum Decision {APPROVED, NEEDS_REVIEW, REJECTED}

  public enum Category {TECHNICAL, ARTIFACT, ANATOMY, TEXT, WATERMARK, PROMPT_COMPLIANCE, COMPOSITION, SUBJECT, CROP, OTHER, SIMILARITY}

  public enum Code {
    CORRUPT_FILE, UNSUPPORTED_FORMAT, FILE_SIZE, RESOLUTION_TOO_LOW, WRONG_DIMENSIONS, WRONG_ASPECT_RATIO,
    DUPLICATE_SHA256, PERCEPTUAL_DUPLICATE, NEAR_DUPLICATE, SIMILARITY_INCOMPLETE, UNEXPECTED_TRANSPARENCY, BLACK_BORDER, NEAR_SOLID_IMAGE, EXTREME_EXPOSURE, BLUR,
