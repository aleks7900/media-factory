...
public record ImageOptions(String provider, String model, AspectRatio aspectRatio, Quality quality,
  ...
  public static ImageOptions defaults() {
    return new ImageOptions(null, null, null, null, null, null, null, null, false, 1);
  }

  public ImageOptions withModel(String selected) {
    return new ImageOptions(provider, selected, aspectRatio, quality, format, negativePrompt, seed,
