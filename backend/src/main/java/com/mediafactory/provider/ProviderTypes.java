...
public final class ProviderTypes {
 ...
 public record Request(String operationId, String prompt, int width, int height, ImageOptions options) {
   public Request(String operationId,String prompt,int width,int height) { this(operationId,prompt,width,height,ImageOptions.defaults()); }
   public Request { options=options==null?ImageOptions.defaults():options; }
 }
