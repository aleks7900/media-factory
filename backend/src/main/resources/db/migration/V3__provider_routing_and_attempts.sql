ALTER TABLE generations
    ADD COLUMN request_options jsonb NOT NULL DEFAULT '{}';
ALTER TABLE generations
    ADD COLUMN provider_route jsonb NOT NULL DEFAULT '[]';
ALTER TABLE generations
    ADD COLUMN routing_mode varchar(16) NOT NULL DEFAULT 'DEFAULT';
ALTER TABLE generations
    ADD COLUMN selected_provider varchar(80);
ALTER TABLE generations
    ADD COLUMN final_provider varchar(80);
ALTER TABLE generations
...
ALTER TABLE jobs
    ADD COLUMN route_index integer NOT NULL DEFAULT 0;
ALTER TABLE jobs
...
ALTER TABLE generation_costs
    ALTER COLUMN input_usage DROP NOT NULL;
ALTER TABLE generation_costs
    ALTER COLUMN output_usage DROP NOT NULL;
ALTER TABLE generation_costs
    ADD COLUMN attempt_id uuid UNIQUE REFERENCES generation_attempts (id);
ALTER TABLE generation_costs
    ADD COLUMN quantity integer NOT NULL DEFAULT 1;
ALTER TABLE generation_costs
    ADD COLUMN actual_cost numeric(18, 8) CHECK (actual_cost >= 0);
ALTER TABLE generation_costs
    ADD COLUMN pricing_status varchar(20) NOT NULL DEFAULT 'ESTIMATED';
ALTER TABLE generation_costs
    ADD COLUMN pricing_version varchar(100) NOT NULL DEFAULT 'task-01';
ALTER TABLE generation_costs
    ADD COLUMN usage_details jsonb NOT NULL DEFAULT '{}';
